    ...
    **/
    ...
    this.COMMANDS = [
        ...
        ["market", PERM.AL, "Shows the market.", "", "Shows the market where you can buy items from other players.", "market", [], CMDSTATE.RDY],
            ...
            ["market remove", PERM.AL, "Removes an item to the market.", "<Offer ID>", "Removes an item from the market place.", "market remove 1", [], CMDSTATE.RDY],
            ...
            ["market evaluate", PERM.AL, "Evaluates an item's value.", "<Item ID>", "Evaluates the price an item could fetch if recycled. Can be used for items you do not have.", "market evaluate std:x", [], CMDSTATE.RDY],
        ...
        /** Theme Module **/
        ["theme", PERM.GH, "Manages themes.", "<Subcommand>", "Group of commands to handle renaming roles for themes. $help theme <sub-command> for detailed help.", "", [], CMDSTATE.UNK],
            ["theme set", PERM.GH, "Adds a term to a theme.", "<Theme Id> <Original Word> <Themed Word>", "Replaces all mentions of a word <Original Word> with <Theme Word> if theme <Theme Id> is selected. If <Theme Id> theme does not yet exist, it is created.", "theme set customTheme citizen notCitizen", ["✅ Replaced 'citizen' with 'notCitizen' in 'customTheme'!"], CMDSTATE.UNK],
            ["theme remove", PERM.GH, "Removes a term from a theme.", "<Theme Id> <Original Word>", "Removes a themed word.", "theme remove customTheme citizen", ["✅ Removed 'citizen' from 'customTheme'!"], CMDSTATE.UNK],
            ["theme list", PERM.GH, "Lists all themes.", "[Theme Id]", "Lists all replaced words for a specific theme, or if no <Theme Id> is set, lists all theme.", "theme list", ["✅ Current Themes: 'customTheme', 'default'!"], CMDSTATE.UNK],
            ["theme select", PERM.GH, "Selects a theme.", "<Theme Id>", "Sets the current theme to <Theme Id>, if set to an invalid theme or 'default', default words are used.", "theme select customTheme", ["✅ Selected 'customTheme' theme!"], CMDSTATE.UNK],
        /** Whispers Module **/
