    ...
    **/
    ...
    this.COMMANDS = [
        ...
        ["schedule", PERM.GM, "Manages schedule.", "<Subcommand>", "Group of commands to handle schedule. Use $help schedule <subcommand> for detailed help. If used without a subcommand runs $schedule list", "", [], CMDSTATE.RDY],
            ...
            ["schedule add", PERM.GM, "Adds a scheduled event.", "<Event Type> <Timestamp> <Event Value>", "Schedules an event. <Timestamp> may be provided in the following formats: HH:MM, <N>s, <N>m, <N>h, <N>d or unix timestamp. When using <Event Type> 'command' specify a command as <Event Value>.", "schedule add command 5m help", ["✅ Command scheduled for in 5 minutes!"], CMDSTATE.RDY],
