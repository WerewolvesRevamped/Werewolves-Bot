        ...
        switch(getRewardType(reward)) {
            ...
            case "bot":
                switch(reward[0].toLowerCase()) {
                    ...
                    case "bot:ban": return `The chance to get banned. Please notify an Admin or Senior GM when you wish to be banned and we will do so. Congratulations!`;
