    ...
    **/
    this.executeAbility = async function(src_ref, src_name, ability, restrictions = [], additionalTriggerData = { parameters: {} }, doNotRecheckRestriction = false) {
        try {
            ...
            await trigger(src_ref, "On Any Action Complex", { action_result: feedback.result, action_target: actionTarget, action_feedback: feedback.msg, ability_type: ability.type, ability_subtype: "" }); 
            if(ability.subtype) await trigger(src_ref, "On Any Action Complex", { action_result: feedback.result, action_target: actionTarget, action_feedback: feedback.msg, ability_type: ability.type, ability_subtype: ability.subtype }); 
