...
module.exports = function() {
        ...
        switch(selectorTarget) {
            ...
            default:
                if(ID_SELECTOR.test(selectorTarget)) { // id selector - this is not in formalizations; this is generated by prompt replies
                    ...
                    return [ id ];
                } else if(ID.test(selectorTarget)) { // id - this is not in formalizations; this is a direct player id
    ...
    **/
    ...
    Parse ability type
    **/
    const abilityTypeNames = ["killing","investigating","targeting","disguising","protecting","applying","redirecting","manipulating","whispering","joining","granting","loyalty","obstructing","poll","announcement","changing","choices","ascend","descend","disband","counting","reset","cancel","","feedback","success","failure","log","process_evaluate","abilities","emit","storing","displaying", "win","shuffle","locking","executing","activating","resurrecting","formatting","copying","switching"];
