...
module.exports = function() {
    ...
    this.loadPollValues = function () {
        pollValues = {
            ...
            "cancel": ["❌", "*Cancel*"],
            "random": ["❓", "*❓*"],
            "yes": [client.emojis.cache.get(stats.yes_emoji), client.emojis.cache.get(stats.yes_emoji)],
            "no": [client.emojis.cache.get(stats.no_emoji), client.emojis.cache.get(stats.no_emoji)],
            "no_": [client.emojis.cache.get(stats.no_emoji)?.name, client.emojis.cache.get(stats.no_emoji)],
            "yes_": [client.emojis.cache.get(stats.yes_emoji)?.name, client.emojis.cache.get(stats.yes_emoji)],
            "a": ["🇦", "Option A"],
            "b": ["🇧", "Option B"],
            "c": ["🇨", "Option C"],
            "d": ["🇩", "Option D"],
