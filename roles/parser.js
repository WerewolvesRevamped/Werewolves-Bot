...
module.exports = function() {
    ...
    **/
    this.parseAbilities = function(abilities, startIndex = 0, parsingDepth = 0, parsingType = "none") {
        ...
        for(let i = startIndex; i < abilities.length; i++) {
            ...
            // debug output
            if(debugMode) console.log("   DEPTH", depth, "INDEX", i, "SEGMENTS", thisAbilitySplit.length);
            ...
            if(depth === parsingDepth) {
                ...
                // ability that is split into two components
                    ...
                    // Process/Evaluate In-Line
                        ...
                        abilitiesParsed.push({ ability: { type: type, sub_abilities: [ { ability: ability.ability } ] }, parameters: ability.parameters ?? {} });    
                    }
                    ...
                    // Implied Evaluate condition
                        ...
                        abilitiesParsed.push({ ability: { type: "evaluate", sub_abilities: [abilityWithCond, ...subAbilities] }, parameters: ability.parameters ?? {} });
                    }
                    // For Each (Multiline)
    ...
    **/
    ...
    const manipSubtype = "(public voting power|special public voting power|hidden public voting power|private voting power|public starting votes|lynch starting votes|election starting votes)";
        ...
        while(inputLines.length > 0) {
            ...
            // start new trigger
                ...
                if(basicTriggerTypes.includes(curTriggerName)) { // normal triggers
                    ...
                    exp = new RegExp("^On " + targetType +  " (Death|Killed|Banished|Banishment|Changed)$", "g");
    ...
    this.inferType = function(targetType) {
        ...
        if(/\->/.test(targetType)) {
            ...
            switch(targetType) {
                ...
                case "@votetext": case "@oldvotetext": case "@newvotetext": return "string";
