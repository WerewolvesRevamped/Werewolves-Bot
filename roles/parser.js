...
module.exports = function() {
    ...
    **/
    ...
    const basicTriggerTypes = [...actionTimings, "Starting", ...passiveTriggers, "On Death", "On Killed", "On Banished", "On Banishment", "On Visited", "On Action", "On Disbandment", "On Lynch", ...electionTriggers, ...defenseTriggers, "On Betrayal", "On Poll Closed", "On Poll Win", "On Role Change", "On Removal", "On End", "Choice Chosen", "On Emitted", "On Redirect", "On Any Action", "On Join"]; // basic trigger types
    const bullets = ["•","‣","◦","·","⁃","⹀"];
